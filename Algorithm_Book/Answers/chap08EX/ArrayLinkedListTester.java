...
class ArrayLinkedListTester {
	...
	enum Menu {
		...
		NEXT(       "着目ノードを進める"),
		PRINT_CRNT( "着目ノードを表示"),
		PURGE_NO(   "同一番号のノードを削除"),	//【演習8-4】
		PURGE_NAME( "同一氏名のノードを削除"),	//【演習8-4】
		RETRIEVE(   "任意のノードを表示"),			//【演習8-5】
		DUMP(       "全ノードを表示"),
		TERMINATE(  "終了");
	...
	public static void main(String[] args) {
		...
		do {
			switch (menu = SelectMenu()) {
			 ...
			 case PURGE_NO :							//【演習8-4】同一番号のノードを削除
					list.purge(Data.NO_ORDER);
					break;

			 case PURGE_NAME :						//【演習8-4】同一氏名のノードを削除
					list.purge(Data.NAME_ORDER);
					break;

			 case RETRIEVE : {						//【演習8-5】任意のノードを表示
