// 演習8-9＋演習8-10
// 循環・重連結リストクラスDoubleLinkedList<E>の利用例
...
class DoubleLinkedListTester {
	...
	enum Menu {
		...
		PRINT_CRNT( "着目ノードを表示"),
		DUMP(       "全ノードを表示"),
		PURGE_NO(   "同一番号のノードを削除"),		//【演習8-9】
		PURGE_NAME( "同一氏名のノードを削除"),		//【演習8-9】
		RETRIEVE(   "任意のノードを表示"),				//【演習8-10】
		TERMINATE(  "終了");
	...
	public static void main(String[] args) {
		...
		DoubleLinkedList<Data> list = new DoubleLinkedList<Data>(); // リストを生成
